...
class Stock extends StatefulWidget {
  ...
  @override
  State<Stock> createState() => _StokState();
}

class _StokState extends State<Stock> {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                toggleButton(widthsize, heightsize),
                ListView.builder(
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text("ชื่อ ${person.name}",
                                        style: textStyle()),
                                    Text(
                                      difference<0? "จำนวน ${person.amount}\nหมดอายุแล้ว ${difference*-1} วัน":
                                      (difference != 0
                                          ? "จำนวน ${person.amount}\nจะหมดอายุใน $difference วัน"
                                          : "จำนวน ${person.amount}\nหมดอายุภายใน 24 ชั่วโมง"),
                                      style: textStyle(),
                                    ),
                                  ],
                                ),
  ...
  TextStyle textStyle2(Color color, fsize) =>
      TextStyle(color: color, fontSize: fsize, fontWeight: FontWeight.bold);
  TextStyle textStyle3(Color color, fsize) =>
  ...
  Widget toggleButton(widthsize, heightsize) => ToggleButtons(
          ...
          children: [
            Padding(
              ...
              child: Text(
                'หมดอายุ',
                style: textStyle2(Colors.red, heightsize * 0.03),
              ),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                'เหลือ 1 วัน',
                style: textStyle2(Colors.amber, heightsize * 0.03),
              ),
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
  ...
  void showEditDialog(
      BuildContext context, Person person, widthsize, heightsize) {
    showDialog(
      context: context,
        ...
        return AlertDialog(
          ...
          content: Form(
            ...
            child: Column(
              ...
              children: [
                TextField(
                  style: textStyle3(Colors.black, heightsize * 0.03),
